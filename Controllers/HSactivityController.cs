...
{
    public class HSactivityController : Controller
    {
        private readonly IAshaOrientationService _service;
        private readonly ILogger<HSactivityController> _logger;
        private readonly IDropdownService _dropdownService;

        public HSactivityController(IAshaOrientationService service, IDropdownService dropdownService)
        {
            _service = service;
